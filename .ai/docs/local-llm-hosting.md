...
llama-server --model .\models\Qwen3.8-27B-Q5_K_M.gguf -fa on -ngl 99 --ctx-size 131072 -ctk q8_0 -ctv q8_0 --spec-default --spec-type draft-mtp --reasoning-budget 4096 --reasoning-budget-message "</think>\n" --jinja --port 8080 --host 0.0.0.0 --tools all
...
#### Configure `omp` to point at your local llama-server:

https://github.com/can1357/oh-my-pi/blob/main/docs/models.md#explicit-provider-discovery
